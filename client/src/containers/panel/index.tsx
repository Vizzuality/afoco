  ...
  return (
    ...
    >
      ...
      <div
        ref={scrollRef}
        className={cn({
          'prose no-scrollbar my-1 flex grow scroll-pt-28 flex-col overflow-y-auto': true,
          'opacity-100': open,
          'opacity-0': !open,
        })}
      >
