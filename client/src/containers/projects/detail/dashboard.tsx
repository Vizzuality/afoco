              ...
              >
                ...
                <div className="flex flex-col">
                  <div className="flex items-end space-x-0.5">
                    <p className="text-5xl font-extrabold text-green-400">{data[value]}</p>
          ...
          <div className="flex h-[70vh] w-full flex-col justify-between gap-4">
                ...
                <div className="space-y-3">
                  {totalInterventionArea.map(({ name, value }) => (
                    <div key={name} className="space-between flex w-full items-end">
                      ...
                      <p className="w-10 text-right font-extrabold">{Math.round(data[value])}</p>
                    </div>
                  ))}
                  <div>
            ...
            <div className="flex h-1/2 w-full gap-4">
              <div className="w-1/2 rounded-xl bg-white p-4 shadow-sm">
                ...
                <p className="py-4 text-3xl font-extrabold">
                  {formatCompactNumber(data.beneficiaries_total) || 0}
                </p>
                <div className="h-32">
                  {data.beneficiaries && (
                    <BarsChart
              ...
              <div className="w-1/2 rounded-xl bg-white p-4 shadow-sm">
                ...
                <p className="py-4 text-3xl font-extrabold">
                  {formatCompactNumber(data.jobs_total) || 0}
                </p>
                <div className="h-32">
                  {data.jobs && (
                    <BarsChart
