...
export const getGetProjectsIdInfiniteQueryOptions = <
  TData = Awaited<ReturnType<typeof getProjectsId>>,
  TError = ErrorType<Error>
>(
  id: number,
  options?: {
    query?: UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectsId>>, TError, TData>;
  }
): UseInfiniteQueryOptions<Awaited<ReturnType<typeof getProjectsId>>, TError, TData> & {
  queryKey: QueryKey;
} => {
  const { query: queryOptions } = options ?? {};
...
export type GetProjectsIdInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProjectsId>>
>;
export type GetProjectsIdInfiniteQueryError = ErrorType<Error>;

export const useGetProjectsIdInfinite = <
  TData = Awaited<ReturnType<typeof getProjectsId>>,
  TError = ErrorType<Error>
>(
  id: number,
  ...
  const queryOptions = getGetProjectsIdInfiniteQueryOptions(id, options);
